<template>
  <BaseLayout v-if="currentData">
    ...
    <div v-if="currentData?.types" class="w-100">
      <Typography tag="h4" color="black" weight="bold" size="md" class="mt-4 w-100"> 상세 정보 및 종류 </Typography>
      <Typography
...
const loadCurrentData = () => {
  ...
  visibleList.value = Array.isArray(currentData.value?.types) ? currentData.value.types.map(() => false) : [];
};
